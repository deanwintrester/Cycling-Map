...
COROS_URL_DICT = {
    ...
    "ACTIVITY_LIST": "https://teamcnapi.coros.com/activity/query?&modeList=200",
}
...
class Coros:
    ...
    async def download_activity(self, label_id):
        ...
        download_url = f"{COROS_URL_DICT.get('DOWNLOAD_URL')}?labelId={label_id}&sportType=200&fileType=4"
        file_url = None
        try:
